%ALIGNEDSENSE_EXP1 script performs the experiment included in Section 
%III.B of the manuscript ''Sensitivity encoding for aligned multishot 
...
%Encoding generation
EncMeth{1}='LinSeq';EncMeth{2}='RadSeq';EncMeth{3}='LinPar';EncMeth{4}='LinSqu';EncMeth{5}='Random';
